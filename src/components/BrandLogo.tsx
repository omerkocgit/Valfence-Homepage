...
export const BrandLogo: React.FC<BrandLogoProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="valfence-v-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#0B1E36" />
            <stop offset="60%" stopColor="#0F3260" />
            <stop offset="100%" stopColor="#0284C7" />
          </linearGradient>
          <linearGradient id="valfence-bar1-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#0E2F59" />
            <stop offset="100%" stopColor="#0284C7" />
          </linearGradient>
          <linearGradient id="valfence-bar2-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#0284C7" />
            <stop offset="100%" stopColor="#0B1E36" />
          </linearGradient>
          <linearGradient id="valfence-bar3-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#0284C7" />
            <stop offset="100%" stopColor="#0B1E36" />
          </linearGradient>
        </defs>
