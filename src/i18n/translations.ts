...
export const translations: Record<'EN' | 'DE', TranslationDictionary> = {
  EN: {
    ...
    hero: {
      eyebrow: 'Renewable Infrastructure Valuation Platform',
    ...
    workspace: {
      ...
      subline: 'Explore how VALFENCE extracts verifiable data from technical advisor documents, highlights source conflicts, and feeds reproducible deterministic DCF calculations.',
      ...
      exportExcelBtn: 'Export Formula Excel (.xlsx)',
      generateMemoBtn: 'Generate 1-Page IC Memo',
    ...
    visualShowcase: {
      ...
      subline: 'Explore how raw transaction documents transform into deterministic, source-linked financial models with interactive graphs and live simulation.',
  ...
  DE: {
    ...
    hero: {
      eyebrow: 'Bewertungsplattform für Erneuerbare-Energien-Infrastruktur',
    ...
    workspace: {
      ...
      headline: 'Source-to-Valuation Live Workspace',
      subline: 'Erleben Sie, wie VALFENCE prüfbare Daten aus Gutachten extrahiert, Dokumentenkonflikte hervorhebt und in reproduzierbare DCF-Berechnungen überführt.',
      ...
      exportExcelBtn: 'Formel-Excel exportieren (.xlsx)',
      generateMemoBtn: '1-Seiten IC-Memo erstellen',
    ...
    visualShowcase: {
      ...
      subline: 'Erleben Sie, wie Rohdokumente in deterministische, quellengestützte Finanzmodelle transformiert werden – mit interaktiven Graphen und Live-Simulation.',
